...
public class Torchlight : MonoBehaviour {
	...
	void Start () {
		...
		Embers.GetComponent<ParticleSystem>().emissionRate=IntensityLight*7f;
		Smoke.GetComponent<ParticleSystem>().emissionRate=IntensityLight*12f;
	}
	...
	void Update () {
		...
		TorchLight.GetComponent<Light>().intensity=IntensityLight
            /2f + Mathf.Lerp(IntensityLight-0.1f, IntensityLight+0.1f, Mathf.Cos(Time.time*30));
